...
use voidray_renderer::{vector::*, traits::AnalyticSurface, ray::{Ray, HitRecord}, aabb::{Bounded, AABB}, vec3};
...
pub trait SDF: Send + Sync {
    ...
    fn normal(&self, point: Vec3) -> Vec3 {
        ...
        (vec3!(ex, ey, ey) * self.sdf(point + vec3!(ex, ey, ey))
                ...
                + vec3!(ex) * self.sdf(point + vec3!(ex))).normalize()
    }
    ...
    fn hit(&self, ray: &Ray, t_min: Float, t_max: Float) -> Option<HitRecord> {
        ...
        loop {
            ...
            if distance < t_min {
                ...
                return Some(HitRecord::new(ro, normal, cum_distance, Vec2::new(0.0, 0.0), ray));
            }
